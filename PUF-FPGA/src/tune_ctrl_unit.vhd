...
architecture Behavioral of tune_ctrl_unit is
    ...
    signal upper_tuning : STD_LOGIC_VECTOR(2 downto 0) := "111"; -- upper ASR length filled with ones
    signal lower_tuning : STD_LOGIC_VECTOR(2 downto 0) := "111"; -- lower ASR length filled with ones
...
begin
    ...
    begin
        ...
        if ASR_tuning_set = '1' then
            upper_tuning <= payload(7 downto 5);
            lower_tuning <= payload(4 downto 2);
        ...
        ASR_tuning(ASR_top_indx*3+2 downto ASR_top_indx*3)       <= upper_tuning;
        ASR_tuning(ASR_bottom_indx*3+2 downto ASR_bottom_indx*3) <= lower_tuning;
    end process;
